...
num_gifs = 100
frames_per_gif = 5
temp_path = 'frames/temp.gif'
model_dir = './fromage_model/'
results_path = 'frames/results.csv'
tgif_path = 'frames/tgif.csv'
...
for idx in range(start_index, start_index + num_gifs):
    ...
    try:
        frames.download_gif(gif_url, temp_path)
    except:
        print(f'Failed \t {gif_url}')
        continue
    
    frame_list = frames.extract_frames(temp_path, frames_per_gif)
