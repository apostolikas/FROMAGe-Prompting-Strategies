...
if __name__ == '__main__':
    ...
    # Create a dataset which contains only the good image-caption pairs
    ...
    # Load language model and tokenizer for the evaluation metric
        ...
        try:
            ...
            for out in augmented_outputs:
                    if type(out) == str:
                        ...
                        #similar_image4.save(str(i)+'_sim1.jpg')
                        similar_image2 = out[1]
                        #similar_image5.save(str(i)+'_sim2.jpg')
                    else:
                        continue

            # Generate caption using the augmented prompt
