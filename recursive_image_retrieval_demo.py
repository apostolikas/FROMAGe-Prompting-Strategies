...
image_directory = "src/recursive_image_retrieval/data/demo_images"




#load the demo captions
df_images = pd.read_csv('./src/recursive_image_retrieval/data/demo_recursive_retrieval.csv')

def encode_image(image_path):
    #encodes the image files as features using CLIP
...
def caption_this(model, model_output):
    ...
    if img_caption[0] == ' A: A: A: A: A: A: A: A':
    ...
    for experiment in range(5):
        ...
        if type(model_outputs[0]) == str:
            ...
            try: 
                ...
                img_name = f'demo_augmenting_set_{index}_{experiment}.png'
...
df_result.to_csv('image_similarity_demo_output.csv')